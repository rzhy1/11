...
### 节点来源- zlib 1.3.1 已是最新版 https://github.com/madler/zlib/releases/download/v1.3.1/zlib-1.3.1.tar.gz
...
- libidn2 有最新版：2.3.7  https://ftp.gnu.org/gnu/libidn/libidn2-2.3.7.tar.gz
...
- gnutls 3.8.8 已是最新版 https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.tar.xz
请求失败，重试中 (1/5)...
请求失败，重试中 (2/5)...
请求失败，重试中 (3/5)...
请求失败，重试中 (4/5)...
请求失败，重试中 (5/5)...
- openssl 获取最新版本失败: 404 Client Error: Not Found for url: https://www.openssl.org/source/old/1.1.1/
